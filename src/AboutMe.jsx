...
const REVEAL_CONTENT = [
  {
    upper: ["Aakarsh Kashyap", "I do C and CUDA", "GitHub: souls-syntax"],
    lower: "systems programmer · low-level enjoyer",
  },
  {
    upper: [
      "C  ·  CUDA  ·  C++  ·  Zig  ·  Lua",
      "OS dev  ·  Shell scripting  ·  GPU programming",
      "sauceOS  ·  sush  ·  tsundere-runtime  ·  C-STL",
    ],
    lower: "stacks & tools",
  },
  {
    upper: [
      "Built an x86_64 OS from bare metal with Limine.",
      "Wrote a POSIX-compliant shell in C++ (sush).",
      "Building a runtime loader in Zig (tsundere-runtime).",
    ],
    lower: "things i actually shipped",
  },
];

const ROLES = [
  { text: "DEV",    color: "#e8c100", bg: "rgba(232,193,0,0.12)",   border: "rgba(232,193,0,0.5)"   },
  { text: "STACK",  color: "#4a8fff", bg: "rgba(74,143,255,0.12)",  border: "rgba(74,143,255,0.5)"  },
  { text: "SHIPPED",color: "#c4001a", bg: "rgba(196,0,26,0.12)",    border: "rgba(196,0,26,0.5)"    },
];
